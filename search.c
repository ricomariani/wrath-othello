...
static int rsearch(uint8_t *me, uint8_t *him, int depth, int lvl);
static int mini(uint8_t *me, uint8_t *him, int depth, int a, int b);
static int maxi(uint8_t *me, uint8_t *him, int depth, int a, int b);

static void bcpy(uint8_t *meT, uint8_t *himT, uint8_t *me, uint8_t *him) {
  *(int64_t *)meT = *(int64_t *)me; 
  *(int64_t *)himT = *(int64_t *)him;
}
...
static int rsearch(uint8_t *me, uint8_t *him, int depth, int lvl) {
  ...
  bs = mini(himT, meT, depth - 1, HORRIBLE, GREAT);
  bx = x;
  by = y;
  ...
  while (remove_scored_move(&x, &y, lvl)) {
    ...
    bcpy(meT, himT, me, him);
    flip(meT, himT, x, y);
    sc = mini(himT, meT, depth - 1, bs, GREAT);
...
static int mini(uint8_t *me, uint8_t *him, int depth, int a, int b) {
  ...
  if (!depth)
    ...
    int found_anything = valid(me, him, depth);
    if (!found_anything) {
